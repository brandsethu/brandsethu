...
export class Backend implements backendInterface {
    ...
    async getAllRequests(): Promise<Array<CorporateRequest>> {
        if (this.processError) {
            try {
    ...
    async getRequest(arg0: bigint): Promise<CorporateRequest> {
        if (this.processError) {
            try {
    ...
    async submitRequest(arg0: CorporateRequest): Promise<void> {
        if (this.processError) {
            try {
