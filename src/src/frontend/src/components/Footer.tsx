...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  const productLinks = [
    { label: "Tissues & Office Supplies", page: "products" },
    { label: "Corrugated & Packaging", page: "products" },
    { label: "Corporate Gift Solutions", page: "products" },
    { label: "Logistics & Warehousing", page: "products" },
